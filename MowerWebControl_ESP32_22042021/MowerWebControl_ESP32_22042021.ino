...
#define VESRION "vom 22.04.2021"
#define CONFIG_MSG_START "config:"

#define SET_IP_SETTING  1  //true=IP-Settings aus programm, false=IP-Settings von Mower
IPAddress myIP(192, 168, 178, ...);
IPAddress network_gateway(192, 168, 178, 100);
IPAddress network_subnet(255, 255, 178, 0);
IPAddress network_dns(192, 168, 178, 1);
char *wifi_network_ssid     = "........";
...
void setup() {
  ...
  delay(500);
  Serial.println("\n\n");
  Serial.println(MSG_HEADER " ESP32 Serial WIFI Bridge with Webinterface " VESRION);
