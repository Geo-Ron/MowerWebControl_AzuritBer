...
class RemoteControl
{
  ...
  private:
    ...
    // custom menu
    void sendCustomMenu(boolean update);
    ...
    void sendPerimeterMenu2(boolean update);
    void sendLawnSensorMenu(boolean update);    
    void sendImuMenu(boolean update);
    void sendImuMenu2(boolean update);
    ...
    void processPerimeterMenu2(String pfodCmd); 
    ...
    void processImuMenu2(String pfodCmd);         
